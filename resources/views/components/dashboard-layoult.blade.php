...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="">
    ...
    <body class="font-sans antialiased  bg-white text-[#20282D]">
      ...
      <div class="flex items-stretch">
          ...
          <div class="lg:hidden w-[60%] h-full md:w-[40%] absolute flex gap-3 z-50 transform -translate-x-full transition-transform duration-500 ease-in-out" id="sidebar-mobile">
                ...
                @if ($item['id']==0)
                  <div class="cursor-pointer border rounded-md py-2 px-2 bg-[#1a1a1d21] border-[#1a1a1d21]">
                    <div class="flex items-center gap-x-2 text-white">
                      ...
                      <a href="{{url($item['url']) }}" class="font-bold">{{ $item['title'] }}</a>
                    </div>
                  </div> 
                @else
          ...
          <div class="hidden lg:block lg:w-[25%] bg-amber-500 py-4 px-6 transform transition-transform duration-500 ease-in-out" id="sidebar">
            <div class="flex flex-shrink-0 items-center">
              <img class="h-8 w-auto" src="https://tailwindui.com/plus/img/logos/mark.svg?color=white" alt="Your Company">
            </div>
            <div class="mt-6 space-y-4">
